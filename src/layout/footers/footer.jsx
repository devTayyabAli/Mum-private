...
const footer_content  = {
    ...
    phone: "+1 (424) 535-1631",
    contact_mail: " info@neoterican.com",
    location: "1309 Coffeen Avenue STE 1200 Sheridan, Wyoming 82801",

    copy_right: <>© Copyright Neoterican LLC. All Rights Reserved – {new Date().getFullYear()}</>,
...
const Footer = () => {
    ...
    return (
        ...
        <footer className="fix">
            <div className="tp-footer__pl-pr p-relative mb-20">
                           ...
                           <div className="col-xl-4 col-lg-4 col-md-7 pb-30 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".5s">
                              <div className="tp-footer__widget footer-col-1">
                                 <Link href="/" className="tp-footer__widget-logo mb-10">
                                    <Image src={logo} alt="" style={{width:"45%"}} />
                                 </Link>
